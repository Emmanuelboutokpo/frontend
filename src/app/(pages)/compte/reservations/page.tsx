...
export default function ReservationsPage() {
	...
	return <main className="min-h-screen bg-[#ffff] px-4 py-8 text-slate-900 sm:px-6 lg:px-12">
		<div className="mx-auto max-w-5xl">
			<Link href="/pages/" className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 hover:text-emerald-700"><ArrowLeft className="h-4 w-4" />Retour à l&apos;accueil</Link>
