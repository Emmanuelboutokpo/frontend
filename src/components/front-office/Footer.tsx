...
const Footer = () => {
    ...
    return (
        <footer className="hidden border-t bg-gray-100 text-foreground pt-14 pb-8 lg:block">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="md:col-span-1 md:text-left">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed mt-4 max-w-md mx-auto md:mx-0">
                            Trouvez les meilleurs hébergements, restaurants et loisirs pour profiter pleinement de vos séjours.
                        </p>
                    </div>

                    {/* Navigation Links - Centré sur mobile, à droite sur desktop */}
                    <div className="md:col-span-1">
                        <h3 className="text-lg font-bold mb-5 text-emerald-800 border-b border-border pb-2 md:text-left">Navigation</h3>
                        <ul className="grid grid-cols-2 gap-x-8 gap-y-3">
                            {navItems.map((item) => (
                                <li key={item.href}>
                                    <Link
                                        href={item.href}
                                        className="text-muted-foreground hover:text-emerald-700 transition-colors flex items-center group"
                                    >
                                        <span className="w-2 h-2 bg-emerald-600 rounded-full mr-3 group-hover:bg-emerald-800 transition-colors"></span>
                                        {item.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div className="md:col-span-1">
                        <h3 className="text-lg font-bold mb-5 text-emerald-800 border-b border-border pb-2 md:text-left">Contactez-nous</h3>
                        <ul className="space-y-4 max-w-xs mx-auto md:mx-0">
                            <li className="flex items-start">
                                <MapPin size={18} className="flex-shrink-0 mt-1 mr-3 text-emerald-700" />
                            ...
                            <li className="flex items-center">
                                <Mail size={18} className="flex-shrink-0 mr-3 text-emerald-700" />
                                <span className="text-muted-foreground text-sm">bestreservs@gmail.com</span>
                            </li>
                        </ul>
                ...
                <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-muted-foreground text-xs">
                        © {currentYear} BestReserv. Tous droits réservés.
                    </p>

                    <div className="flex flex-wrap justify-center gap-4 mt-4 md:mt-0">
                        <Link
                            href="/mentions-legales"
                            className="text-muted-foreground hover:text-emerald-700 text-xs transition-colors"
                        >
                            Mentions légales
                        </Link>
                        <Link
